...
const HomePage = () => {
  ...
  return (
    <InitialBackground
      onDragOver={preventDragDropOutside}
      onDrop={preventDragDropOutside}
    >
      <img
        src={process.env.PUBLIC_URL + '/images/obabo_logo_with_title.png'}
        alt="Splash Screen"
      />
      <ImageUploadPaddingBox>
        <ImageFileUploadComponent
        ...
        >
          <ImageUploadIcon>
            <DefaultIcon
              src={
                process.env.PUBLIC_URL + '/images/icons/photo_upload_icon.png'
              }
              isHovered={isHovered}
            />
            <UploadIcon
              src={
                ...
                '/images/icons/photo_upload_active_icon.png'
              }
              isHovered={isHovered}
            />
          </ImageUploadIcon>
          <ImageUploadTextPaddingBox>
            <ImageUploadText>어딜 가고 싶나요?</ImageUploadText>
            <ImageUploadText>이미지로 알려주세요!</ImageUploadText>
          </ImageUploadTextPaddingBox>
        </ImageFileUploadComponent>
        <HiddenFileInput
          type="file"
